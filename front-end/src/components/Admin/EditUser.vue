...
<!--          <input class="g-hidden-xs-up g-pos-abs g-cktop-5 g-right-0" id="confirmed" name="confirmed" type="checkbox" v-model="checked">-->
<!--          <div class="u-check-icon-radio-v7">-->
<!--            <i class="fa" data-check-icon="" data-uncheck-icon=""></i>-->
<!--          </div>-->
<!--        </label>-->
<!--        &lt;!&ndash; End Toggles Views &ndash;&gt;-->
      </div>
      ...
      <div class="form-group">
        ...
        <div>
          <!-- Inline Radios -->
          <label v-for="(role, index) in roles.items" v-bind:key="index" class="form-ck-inline">
            <input class="g-hidden-xs-up g-pos-abs g-cktop-5 g-left-0" name="role_id" type="radio" v-bind:id="role.id" v-bind:value="role.id" v-model="picked">
